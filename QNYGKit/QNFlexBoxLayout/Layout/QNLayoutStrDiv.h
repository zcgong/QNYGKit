...
+ (instancetype)divWithAttributedString:(NSAttributedString *)attributedString;
+ (instancetype)divWithAttributedString:(NSAttributedString *)attributedString lineNum:(NSUInteger)lineNum;
@end
